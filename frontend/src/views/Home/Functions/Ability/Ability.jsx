        ...
        <Link to={url} className="functions__ability ability">
            ...
            <div className="ability__action">
                ...
                <svg className="ability__icon" xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 34 34" fill="none">
                    ...
                    <path className="ability__icon_arrow" d="M21.25 4.25H29.75V12.75 M14.1665 19.8333L29.7498 4.25" strokeWidth="2.83333" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
            </div>
        </Link>
    );
